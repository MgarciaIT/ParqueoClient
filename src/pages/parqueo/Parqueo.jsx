...
const Parqueo = () => {
  ...
  ********************************************************************************************* */
  ...
  const getParqueo = async() => {
    await axios.get("https://parqueosantaneco-a789cc438046.herokuapp.com/api/parqueo")
    .then(response => {
  ...
  const getCliente = async() => {
    await axios.get("https://parqueosantaneco-a789cc438046.herokuapp.com/api/parqueo/clientes")
    .then(response => {
  ...
  const getMarca = async() => {
    await axios.get("https://parqueosantaneco-a789cc438046.herokuapp.com/api/parqueo/marca")
    .then(response => {
  ...
  const getPago = async() => {
    await axios.get("https://parqueosantaneco-a789cc438046.herokuapp.com/api/parqueo/pago")
    .then(response => {
      console.log(response.data)
  ...
  const getDocumento = async() => {
    await axios.get("https://parqueosantaneco-a789cc438046.herokuapp.com/api/parqueo/documento")
    .then(response => {
      console.log(response.data)
  ...
  const getDescuento = async() => {
    await axios.get("https://parqueosantaneco-a789cc438046.herokuapp.com/api/parqueo/descuento")
    .then(response => {
      console.log(response.data)
  ...
  const getUltimo = async (e) =>{
    await axios.get("https://parqueosantaneco-a789cc438046.herokuapp.com/api/parqueo/ultimo")
    .then(response => {
  ...
  const Guardar = async() => {
    await axios.post("https://parqueosantaneco-a789cc438046.herokuapp.com/api/parqueo/crear", body)
    .then(response => {
