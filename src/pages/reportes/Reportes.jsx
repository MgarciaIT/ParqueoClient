...
const Reportes = () => {
  ...
  const getCorteX = async (e) => {
    try {
      await axios.get("https://parqueosantaneco-a789cc438046.herokuapp.com/api/reportes/cortex")
      .then(response => {
  ...
  const getCorteZ = async(e) => {
    try {
      await axios.get("https://parqueosantaneco-a789cc438046.herokuapp.com/api/reportes/cortez")
      .then(response => {
        console.log(response.data)
